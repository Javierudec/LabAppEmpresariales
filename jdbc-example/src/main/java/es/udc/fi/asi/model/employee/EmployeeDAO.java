...
public interface EmployeeDAO {
	...
	/**
	 * Increase salary of all employees working on department "departmentId".
	 * Salary is multiplied by percent.
	 * @param departmentId Department identifier.
	 * @param percent percent in which salary will be increased.
	 */
